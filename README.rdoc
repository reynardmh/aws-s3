= Note
This forked aws-s3 removes cattr_* methods from Class extension and add activesupport as a gem dependency
to address the problem on newer Rails (or Ruby). 
This fixes the problem described here https://github.com/marcel/aws-s3/issues/102
